...
def organization_post():
    ...
    c.execute("""
        ...
        (organization_id, organization_name, activity_name, purpose, activity_date, activity_time,
         address, volunteers_required, volunteer_skills, contact)
