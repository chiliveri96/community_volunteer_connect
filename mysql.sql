...
CREATE DATABASE community_connect CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
RENAME TABLE organization TO organizations;
-- Organizations
...
ALTER TABLE organizations ADD COLUMN email VARCHAR(120) UNIQUE;
ALTER TABLE organizations
ADD COLUMN org_name VARCHAR(100) AFTER id;
